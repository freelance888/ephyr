describe("ADD BACKUP INPUT", () => {
	...
	it("Assert", () => {
		cy.get("span:contains('/it/main')").should('have.text', 'rtmp://'+Cypress.env('host')+'/it/main')
		cy.get("span:contains('/it/backup')").should('have.text', 'rtmp://'+Cypress.env('host')+'/it/backup')
	});
