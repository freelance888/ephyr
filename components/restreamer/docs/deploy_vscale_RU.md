...
```bash
ssh root@ip_адрес_сервера "curl -sL https://raw.githubusercontent.com/ALLATRA-IT/ephyr/master/components/restreamer/deploy/provision/ubuntu-20-04-x64.sh  | EPHYR_VER=0.7.0 WITH_INITIAL_UPGRADE=1 bash -s"
```
